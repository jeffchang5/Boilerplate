package io.jeffchang.challenge.ui.review.viewmodel
...
import io.jeffchang.challenge.data.model.TextData
import io.jeffchang.challenge.ui.review.interactor.ReviewInteractor
    ...
    fun getReviews() {
        ...
        reviewInteractor.getReviews()
                ...
                .subscribe({
                    ...
                    _textDataLiveData.value = TextData(R.string.error_failure)
                })
